...
export default function Privacy() {
  return (
    ...
    <main className="h-screen">
      ...
      <UnderPageTitle>てびき</UnderPageTitle>
      <div className="w-11/12 sm:w-4/5 lg:w-7/12 mx-auto text-center px-4 pb-12 tracking-widest text-gray-900">
        <h2 className="text-type02 w-full text-lg md:text-lg mb-10">プライバシーポリシー</h2>
        
        <h3 className="text-type02 w-full text-md md:text-md mb-3">個人情報の管理方法</h3>
        ...
        <h3 className="text-type02 w-full text-md md:text-md mb-3">個人情報の提供</h3>
        ...
        <h3 className="text-type02 w-full text-md md:text-md mb-3">個人情報の利用目的について</h3>
        ...
        <h3 className="text-type02 w-full text-md md:text-md mb-3">個人情報保護に関するお問い合わせ先</h3>
